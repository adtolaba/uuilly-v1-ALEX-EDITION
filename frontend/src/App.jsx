                ...
                >
                  ...
                  <div className="flex-1 flex flex-col overflow-hidden relative">
                      ...
                      <div className={cn(
                        ...
                        {isAtWelcomeScreen ? (
                          ...
                          <>
                            ...
                            {isLoadingResponse && (
                              <ProcessingIndicator agentName={activeAgentName} agentIcon={activeAgentIcon} />
                            )}
                    ...
                    {!isAtWelcomeScreen && currentView !== 'admin' && (
                      <div ref={footerRef} className="absolute bottom-0 left-0 right-0 w-full bg-gradient-to-t from-background via-background/95 to-transparent pt-20 3xl:pt-16 pb-6 md:pb-12">
